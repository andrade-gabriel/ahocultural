...
import { getCitiesByStateAsync, getCountriesAsync, getStatesByCountryAsync } from './handler'
...
const handlerFactory = new Map<string, HandlerFn>([
    ["/v1/admin/geo/country", getCountriesAsync],
    ["/v1/admin/geo/state/{countryid}", getStatesByCountryAsync],
    ["/v1/admin/geo/city/{stateid}", getCitiesByStateAsync]
]);
