...
import { getByIdHandler, listIdHandler, listChildrenHandler } from './handler'
...
const handlerFactory = new Map<string, HandlerFn>([
    ["/v1/public/category", listIdHandler],
    ["/v1/public/category/{id}", getByIdHandler],
    ["/v1/public/category/{id}/children", listChildrenHandler]
]);
