...
CREATE TABLE IF NOT EXISTS `studio_category` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `studio_id` INT UNSIGNED NOT NULL,
  `name_pt` MEDIUMTEXT NOT NULL,
  `name_en` MEDIUMTEXT NOT NULL,
  `name_es` MEDIUMTEXT NOT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `studio_category_media` (
  `studio_id` INT UNSIGNED NOT NULL,
  `studio_category_id` INT UNSIGNED NOT NULL,
  `file_path` varchar(255) NOT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`studio_id`, `studio_category_id`, `file_path`),
  FOREIGN KEY (`studio_id`) REFERENCES `studio`(`id`),
  FOREIGN KEY (`studio_category_id`) REFERENCES `studio_category`(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
